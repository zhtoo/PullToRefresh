...
/**
 * 作者：zhanghaitao on 2017/11/10 10:22
 * 邮箱：820159571@qq.com
 *
 * @describe:解决PtrFrameLayout和ViewPager的滑动冲突，
 * 原项目给出的方案是ptrFrame.disableWhenHorizontalMove(true);经过验证仍然不能解决问题
 * @call：setViewPager();
 */
...
public class PtrHTFrameLayout extends PtrFrameLayout {
     ...
     * @param viewPager
     */
    public void setView(View viewPager) {
